import { ICONS, METRIC_ICON } from "@/constants/icons";
import {
  Eye,
  Heart,
  MessageCircle,
...
// — Metric Icons —
const METRIC_ICONS = {
  users: METRIC_ICON.users,
  growth: METRIC_ICON.growth,
  likes: METRIC_ICON.likes,
  views: METRIC_ICON.views,
  comments: METRIC_ICON.comments,
  shares: METRIC_ICON.shares,
  stars: METRIC_ICON.stars,
