...
import { CheckCircle2, ChevronDown, IdCard, Layout, Plus, Sparkles, X } from 'lucide-react'
...
import TrustMRRPanel from '@/components/trustmrr/TrustMRRPanel'
...
interface LeftPanelProps {
    ...
    onTrustMRRDataFetched: (data: TrustMRRStartup) => void
    trustMRRTemplate: TrustMRRCardTemplate | null
    onTrustMRRTemplateSelect: (t: TrustMRRCardTemplate) => void
...
export default function LeftPanel({
    ...
    trustMRRData,
    onTrustMRRDataFetched,
    trustMRRTemplate,
    onTrustMRRTemplateSelect,
    ...
    return (
        <div className="bg-card w-[360px] border-r-2 border-white/10 flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scroll">
                <Tabs defaultValue={'milestone-studio'} className={'w-full flex-1'}>
                    <TabsList className={'w-full'}>
                        <TabsTrigger
                            value={'milestone-studio'}
                    ...
                    <TabsContent value={'milestone-studio'}>
                    ...
                    <TabsContent value={'trustmrr'}>
                        <div className='space-y-6'>
                            ...
                            <TrustMRRPanel
                                ...
                                selectedTemplate={trustMRRTemplate}
                                onSelectTemplate={onTrustMRRTemplateSelect}
                                trustMRRData={trustMRRData}
                                onDataFetched={onTrustMRRDataFetched}
                            />
                        </div>
                    </TabsContent>
                </Tabs>
