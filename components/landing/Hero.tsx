    ...
    <section className="relative w-full min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col items-center pt-32 pb-16 px-6 bg-black">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
          <Link href="/" className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-white text-black text-sm font-semibold hover:bg-white/90 transition-all shadow-[0_0_25px_rgba(255,255,255,0.2)] active:scale-95">
            Open Editor <Sparkles size={14} fill="black" />
          </Link>
          <Link
            href="https://github.com/nikhilsaiankilla/milestone-studio"
            target="_blank"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-full border border-white/10 bg-white/5 text-white/80 text-sm font-medium hover:bg-white/10 transition-all"
          >
            Star on GitHub {stars !== null && (
              <span className="ml-1 flex items-center gap-1 border-l pl-2 border-white/10 text-white/40">
